...
import model.FormParser;
import model.SmtpAgent;
...
//                    out.flush();
    ...
    private boolean sendMessage(HttpServletRequest request) {
        ...
        String uploadDirectory = this.getServletContext().getRealPath("temp/upload");
        FormParser parser = new FormParser(request, uploadDirectory);
        parser.parse();
