...
/**
 * 책임: enctype이 multipart/form-data인 HTML 폼에 있는
 *       각 필드와 파일 정보 추출
 * @author jongmin
 */
public class FormParser {
    ...
    // LJM 131222 - should be changed
    //private final String uploadTargetDir = "C:/temp/upload";
    private String uploadTargetDir = "/var/spool/WebMailSystem/upload";

    public FormParser(HttpServletRequest request, String uploadDirectory) {
        this.request = request;
        this.uploadTargetDir = uploadDirectory;
    }
