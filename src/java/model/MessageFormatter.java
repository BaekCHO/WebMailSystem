...
public class MessageFormatter {
    ...
    private String downloadTempDir = null; // LJM 131222 : added

    public MessageFormatter(String userid, String downloadTempDir) {
        this.userid = userid;
    ...
    public String getMessageTable(Message[] messages) {
        ...
        for (int i = messages.length - 1; i >= 0; i--) {
            MessageParser parser = new MessageParser(messages[i], userid, downloadTempDir);
...
//        return "MessageFormatter 테이블 결과";
    ...
    public String getMessage(Message message) {
        ...
        MessageParser parser = new MessageParser(message, userid, downloadTempDir);
        parser.parse(true);
