...
public class MessageParser {
    ...
    private String downloadTempDir = "C:/temp/download/";  // LJM 131222 : "final" remove
    private String userid;

    public MessageParser(Message message, String userid, String downloadTempDir) {
